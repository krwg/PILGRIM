export const PILIGRIM_THEME_CLASS = {
    dossier: 'paper',
    paper: 'white',
    sepia: 'sepia',
    night: 'night',
};
export function legacyThemeClass(themeName) {
...
export function applyTheme(theme, target = typeof document !== 'undefined' ? document.body : null) {
    if (!target)
        return;
